        ...
        <div className='container'>
            <div className='row'>
                ...
                <div className='col-md-12'>
                    ...
                    <ul>
                        <li>
                            <b>Short-term objectives:</b> These objectives can be achieved immediately. In the short-term, the individuals are trained to be an entrepreneur and made competent enough to scan the existing market situation and environment. The person, who would be the future entrepreneur, should first set the goal as an entrepreneur. The information related to the existing rules and regulations is essential at this stage.
                        </li>
                        <li>
                            <b>Long-term objectives:</b> The ultimate objective is that the trained individuals successfully establish their own business and they should be equipped with all the required skills to run their business smoothly.
                        </li>
                    </ul>
                </div>
                ...
                <div className='col-md-12 mb-4'>
                    <h3>Scheme</h3>
                    <h5>
                        The Govt. of NCT of Delhi has launched the scheme of Entrepreneurship Development Programme for the students of Higher Education.
                    </h5>
                    <h5>
                    Govt. of NCT of Delhi has sanctioned the grant of Rs. 5,000/- to 774 Candidates during FY 2021-22
                    </h5>
                    <h5>
                    Claim form to be filled by Students :<a href='https://docs.google.com/forms/d/1EpcCDtZxbpq6BuwnVlzwgdhUXl6qz1R_AE5HPlRZMBg/edit' target="_blank">Link</a>   
                    </h5>
                    <h5>
                    Student List : Notice for submission of <a href='http://ipu.ac.in/Pubinfo2022/n0704225%20(3).pdf' target="_blank">Claim</a>
                    </h5>
                </div>
